...
const Order = ({order}) => {
  ...
  return (
    <div className='container mx-auto py-8 px-4 md:px-16 lg:px-24'>
        ...
        <p>Your Oredr has been placed successfully you will receive an email regarding your order</p>
        <div className='mt-6 p-4 border rounded-lg bg-gray-100'>
            ...
            <div className='mt-6 flex justify-around'>
                <button className='bg-green-600 text-white py-2 px-4 hover:bg-green-800'>Track Order</button>
